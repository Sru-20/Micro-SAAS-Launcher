 ...
 *
 * Blueprint : demo_marketplace
 * Generated : 2026-04-17T15:33:06.635Z
 * Project ID: proj_marketplace_demo
 */
...
export const APP_NAME = "Demo Marketplace";
export const PROJECT_ID = "proj_marketplace_demo";
export const TEMPLATE = "marketplace";
export const MODULES: string[] = [
  "auth"
];
export const ENABLE_AUTH = true;
export const TABLE_PREFIX = "demo_marketplace";
