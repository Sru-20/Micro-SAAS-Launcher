...
/**
 * DynamicForm — two modes:
 *
 * 1. Standalone mode (tableName + projectId provided):
 *    Inserts a row directly into Supabase on submit.
 *    Use this on [dynamic_page] form sections.
 *
 * 2. Controlled mode (onSubmit provided):
 *    Delegates to the caller's onSubmit handler.
 *    Use this inside AutoCRUD for create/edit flows.
 */
export default function DynamicForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const coerced = coerce(fields, values);
    ...
    try {
      if (tableName && projectId) {
        ...
        throw new Error("DynamicForm: provide either tableName+projectId or onSubmit.");
      }
