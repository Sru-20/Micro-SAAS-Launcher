...
const DEMO_STORAGE_KEY = "msa_fullapp_user_v1";
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const signInWithGoogle = useCallback(async (nextPath = "/dashboard") => {
  ...
  return (
    <div className="auth-card">
      <div className="auth-card-head">
        ...
        <p className="auth-subtitle">Sign in to save forms and dashboard data to your database.</p>
      </div>
        ...
        {hasSupabaseEnv() ? (
          <>
            ...
            <p className="muted small">
              Sessions use cookies so your requests include a JWT — required for RLS and writes to
              your blueprint tables.
            </p>
          </>
        ) : (
          <>
            ...
            <p className="muted small">
              No <code>NEXT_PUBLIC_SUPABASE_*</code> env vars — database writes will not work until
              configured.
            </p>
          </>
        )}
